...
function drawCell(x, y) {
  ...
  _session2['default'].canvasCtx.strokeStyle = _session2['default'].snakeColor;
...
function drawElements() {
  ...
  _session2['default'].canvasCtx.fillText('Score: ' + _session2['default'].score, 5, _session2['default'].height - 5);
}
...
function checkCollision(x, y) {
  ...
  try {
    for (var _iterator = _session2['default'].snake[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
},{"./session":3,"lodash":1}],3:[function(require,module,exports){
'use strict';
